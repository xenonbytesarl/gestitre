...
public interface UserApplicationViewMapper {
    ...
    @Mapping(expression = "java(cm.xenonbyte.gestitre.domain.admin.vo.Timezone.valueOf(createUserViewRequest.getTimezone().name()))", target = "timezone")
    @Mapping(expression = "java(cm.xenonbyte.gestitre.domain.admin.vo.Language.valueOf(createUserViewRequest.getLanguage().name()))", target = "language")
    ...
    @Mapping(source = "roles", qualifiedByName = "toRoles", target = "roles")
    @Nonnull User toUser(@Nonnull @Valid CreateUserViewRequest createUserViewRequest);

    @Named("toRoles")
    Set<Role> toRoles(@Nonnull @Valid Set<RoleView> roles);

    @BeanMapping(ignoreByDefault = true)
    @Mapping(source = "id", target = "id.value")
    @Mapping(source = "name", target = "name.text.value")
    @Mapping(source = "active", target = "active.value")
    @Mapping(source = "permissions", qualifiedByName = "toPermissions", target = "permissions")
    @Nonnull Role toRole(@Nonnull @Valid RoleView role);

    @Named("toPermissions")
    Set<Permission> toPermissions(@Nonnull @Valid Set<PermissionView> permissions);

    @BeanMapping(ignoreByDefault = true)
    @Mapping(source = "id", target = "id.value")
    @Mapping(source = "name", target = "name.text.value")
    @Nonnull Permission toPermission(@Nonnull @Valid PermissionView permission);
    ...
    @Mapping(target = "timezone", expression = "java(cm.xenonbyte.gestitre.application.admin.dto.TimezoneView.valueOf(user.getTimezone().name()))")
    @Mapping(target = "language", expression = "java(cm.xenonbyte.gestitre.application.admin.dto.LanguageView.valueOf(user.getLanguage().name()))")
    ...
    @Mapping(target = "roles", qualifiedByName = "toRoleViews", source = "roles")
    ...
    @Mapping(target = "permissions", qualifiedByName = "toPermissionViews", source = "permissions")
    ...
    @Mapping(source = "email", target = "email.text.value")
    @Mapping(source = "name", target = "name.text.value")
    @Mapping(expression = "java(cm.xenonbyte.gestitre.domain.admin.vo.Timezone.valueOf(updateUserViewRequest.getTimezone().name()))", target = "timezone")
    @Mapping(expression = "java(cm.xenonbyte.gestitre.domain.admin.vo.Language.valueOf(updateUserViewRequest.getLanguage().name()))", target = "language")
    ...
    @Nonnull @Valid SearchUsersPageInfoViewResponse toSearchUsersPageInfoViewResponse(@Nonnull PageInfo<User> userPageInfo);
