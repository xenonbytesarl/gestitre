 ...
 */
@DomainEvent
public final class MailTemplateCreatedEvent extends MailTemplateEvent{
    public MailTemplateCreatedEvent(MailTemplate mailTemplate, ZonedDateTime createdAt) {
