-- PermissionModel for certificate template
...
-- Permissions for the role User to read certificate template, user and company
...
-- Permissions for the role Admin to read certificate template, user and company
...
-- Permissions for the role System to read, create and update certificate template, user and company
