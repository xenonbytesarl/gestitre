...
insert into t_user (c_id, c_created_at,  c_name, c_email, c_password, c_account_enabled, c_credential_expired, c_account_locked, c_account_expired, c_use_mfa, c_failed_login_attempt, c_tenant_id, c_company_id, c_timezone) values
   ('01937564-456e-7514-8c6c-1db19c1614d6', current_timestamp, 'Administrator', 'ambiandji@gmail.com', '$2a$12$251yRnRsGv9U8bAtwgUlV.8qRBTNvWVFKlhHPWApk9ct7DBCIJjam', true, false, false, false, true, 0, '01937563-b2fc-79f9-bf40-d03bc39383f1', '01937563-f905-7965-a014-da683621056c', 'Africa_Douala');
