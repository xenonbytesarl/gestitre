...
public interface UserJpaMapper {
    ...
    @Mapping(expression = "java(TimezoneJpa.valueOf(user.getTimezone().name()))", target = "timezoneJpa")
    @Mapping(expression = "java(LanguageJpa.valueOf(user.getLanguage().name()))", target = "languageJpa")
    ...
    @Mapping(target = "timezone", expression = "java(cm.xenonbyte.gestitre.domain.admin.vo.Timezone.valueOf(userJpa.getTimezoneJpa().name()))")
    @Mapping(target = "language", expression = "java(cm.xenonbyte.gestitre.domain.admin.vo.Language.valueOf(userJpa.getLanguageJpa().name()))")
