...
public interface CompanyJpaMapper {
    ...
    @Mapping(expression = "java(company.getLogoFilename() == null || company.getLogoFilename().text().value().isEmpty()? null: company.getLogoFilename().text().value())", target = "logoFilename")
    @Mapping(expression = "java(company.getStampFilename() == null || company.getStampFilename().text().value().isEmpty()? null: company.getStampFilename().text().value())", target = "stampFilename")
    ...
    @Mapping(target = "address.city", expression = "java(cm.xenonbyte.gestitre.domain.common.vo.City.of(cm.xenonbyte.gestitre.domain.common.vo.Text.of(companyJpa.getAddressJpa().getCity())))")
    @Mapping(target = "address.zipCode", expression = "java(cm.xenonbyte.gestitre.domain.common.vo.ZipCode.of(cm.xenonbyte.gestitre.domain.common.vo.Text.of(companyJpa.getAddressJpa().getZipCode())))")
    @Mapping(target = "address.country", expression = "java(cm.xenonbyte.gestitre.domain.common.vo.Country.of(cm.xenonbyte.gestitre.domain.common.vo.Text.of(companyJpa.getAddressJpa().getCountry())))")
    @Mapping(target = "contact.phone", expression = "java(companyJpa.getContactJpa().getPhone() == null || companyJpa.getContactJpa().getPhone().isEmpty() ? null: cm.xenonbyte.gestitre.domain.common.vo.Phone.of(cm.xenonbyte.gestitre.domain.common.vo.Text.of(companyJpa.getContactJpa().getPhone())))")
    ...
    @Mapping(target = "contact.email", expression = "java(cm.xenonbyte.gestitre.domain.common.vo.Email.of(cm.xenonbyte.gestitre.domain.common.vo.Text.of(companyJpa.getContactJpa().getEmail())))")
    ...
    @Mapping(target = "logoFilename", expression = "java(companyJpa.getLogoFilename() == null || companyJpa.getLogoFilename().isEmpty()? null: cm.xenonbyte.gestitre.domain.common.vo.Filename.of(cm.xenonbyte.gestitre.domain.common.vo.Text.of(companyJpa.getLogoFilename())))")
    @Mapping(target = "stampFilename", expression = "java(companyJpa.getStampFilename() == null || companyJpa.getStampFilename().isEmpty()? null: cm.xenonbyte.gestitre.domain.common.vo.Filename.of(cm.xenonbyte.gestitre.domain.common.vo.Text.of(companyJpa.getStampFilename())))")
    ...
    @Mapping(target = "stockQuantity", expression = "java(companyJpa.getStockQuantity() == null? null: cm.xenonbyte.gestitre.domain.common.vo.Quantity.of(companyJpa.getStockQuantity()))")
